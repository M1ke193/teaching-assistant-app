package com.example.teaching_assistant.GiaoVien_Activity.NhanTin;
...
import com.example.teaching_assistant.SinhVien_Activity.NhanTin.SinhVienNhanTinAdapter;
...
public class GiaoVienNhanTin extends Fragment {
            ...
            public void onClick(View v) {
                ...
                lop.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        String tenNguoiChat = task.getResult().getString("giaoVien");
                        ...
                        lop.collection("TinNhan").add(tinNhanMoi);
                    }
                });
            }
        });
