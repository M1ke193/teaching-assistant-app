...
public class SinhVienXemBanAdapter extends RecyclerView.Adapter<SinhVienXemBanAdapter.viewholder>{
    private ArrayList<SinhVienModel> data;
    public SinhVienXemBanAdapter(ArrayList<SinhVienModel> data)
    {
        this.data = data;
    }
    @NonNull
