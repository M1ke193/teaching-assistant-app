...
public class GiaoVienNhanTinAdapter extends RecyclerView.Adapter<GiaoVienNhanTinAdapter.viewholder>{
    private ArrayList<TinNhanModel> data;
    Context context;
    String maLop;
    public static final int THE_RECEIVER = 0;
    public static final int THE_SENTER = 1;
    public GiaoVienNhanTinAdapter(ArrayList<TinNhanModel> data, Context context, String maLop)
    {
        this.data = data;
